<template>
    <div class="md:flex flex-col hidden">
        <div class="relative inline-block">
            ...
            />
            <span v-if="!offline && !loading" data-text="Discord Status: online" class="tooltip w-8 h-8 rounded-full bg-emerald-500 border-4 border-emerald-600 absolute right-4 bottom-0.5" />
